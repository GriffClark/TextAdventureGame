	...
	public static void main (String[] args) { 	
		...
		while (true){
			...
			if (userInput.equals ("help")) {
				...
				userInput = keyboard.next(); // this statement stops the infinite loop 
				...
				sword.getNewSword();
				System.out.println("However, the first mate tells the captian that you should go around it and try to run. \nThe captian turns to you. \nDo you tell him to 'fight' or 'flee'");
				userInput = keyboard.next();
			}//ends keep going
